...
fun dateStrToDigit(str: String): String {
    ...
    try {
        day = date[0].toInt()
        month = getKey(months, date[1]) ?: throw NumberFormatException("Пожалуйста, введите правильный месяц")
        year = date[2].toInt()
...
fun dateDigitToStr(digital: String): String {
    ...
    try {
        day = date[0].toInt()
        month = months[date[1].toInt()] ?: throw NumberFormatException("Пожалуйста, введите правильный месяц")
        year = date[2].toInt()
    } catch (e: NumberFormatException) {
        return ""
    }
